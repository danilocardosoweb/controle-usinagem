...
const Configuracoes = () => {
  ...
  const adicionarCfg = async () => {
    try {
      ...
      setNovoCfg({ ferramenta: '', peso_linear: '', comprimento_mm: '', pcs_por_pallet: '', ripas_por_pallet: '', teorico_produtividade_pcs_hora: '', embalagem: 'pallet', pcs_por_caixa: '' })
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  ...
                  {(ferramentasCfg || []).length === 0 && (
                    <tr>
                      <td className="px-6 py-6 text-center text-gray-500" colSpan="9">Nenhum cadastro</td>
                    </tr>
                  )}
                  {(ferramentasCfg || []).length > 0 && ferramentasExpedicaoFiltradas.length === 0 && (
                    <tr>
                      <td className="px-6 py-6 text-center text-gray-500" colSpan="9">Nenhum cadastro encontrado para o filtro informado</td>
                    </tr>
                  )}
                </tbody>
              </table>
