  ...
  return (
    <div className="space-y-6">
      ...
      {abaAtiva === 'documentos-ferramentas' && (
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow p-6">
            <h2 className="text-lg font-semibold text-gray-700 mb-4">Documentos por Ferramenta</h2>
            <p className="text-sm text-gray-600 mb-6">
              Gerencie PDFs de desenhos, fichas de processo e fotos de padronização de palete para cada ferramenta.
            </p>
            
            {(ferramentasCfg || []).length === 0 ? (
              <div className="bg-gray-50 rounded-lg p-8 text-center">
                <p className="text-gray-500 font-medium">Nenhuma ferramenta cadastrada</p>
                <p className="text-sm text-gray-400 mt-2">Adicione uma ferramenta na aba "Expedição" primeiro.</p>
              </div>
            ) : (
              <div className="space-y-6">
                {(ferramentasCfg || []).map(cfg => (
                  <div key={cfg.id} className="border border-gray-200 rounded-lg p-6 bg-white hover:shadow-md transition-shadow">
                    <GerenciadorDocumentosFerramentas 
                      ferramentaId={cfg.ferramenta}
