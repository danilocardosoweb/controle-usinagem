...
const ApontamentosParadas = () => {
  ...
  useEffect(() => {
    ...
    if (dataParam) setFiltroData(dataParam)
    if (turnoParam) setFiltroTurno(turnoParam)
  }, [location.search])
  ...
  }, [paradas, filtroData, filtroOperador, filtroTurno])
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-gray-700">Nova Parada</h2>
          <button
            type="button"
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {(filtroData || filtroOperador || filtroTurno) && (
              <button
                onClick={() => { setFiltroData(''); setFiltroOperador(''); setFiltroTurno(''); }}
