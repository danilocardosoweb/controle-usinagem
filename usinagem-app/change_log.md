# Log de Alterações
[16/01/2026 13:22] - [Estoque] - [Sistema de Numeração Serial para Ferramentas Idênticas: campo numero_serial para diferenciar ferramentas do mesmo tipo (ex: Fresa-001, Fresa-002), rastreamento individual para afiação e manutenção, validação de duplicidade por código+serial, identificador único no banco] - [Cascade]
[16/01/2026 13:05] - [Estoque] - [Cadastro Inteligente de Ferramentas CNC: modal avançado com campos específicos (Código, Corpo mm, Quant. Pç, Vida útil com múltiplas unidades, Última troca, Responsável, Ativo), cálculos automáticos de restante, validações inteligentes, interface em 4 seções coloridas, novos campos no banco: corpo_mm, quant_pcs, vida_valor, vida_unidade, ultima_troca] - [Cascade]
[16/01/2026 12:52] - [Estoque] - [Sub-abas Insumos e Status de Ferramentas: reorganização criativa da aba "Ferramentas e Insumos" em duas sub-abas separadas com dashboards visuais, indicadores em cards com gradientes, ações rápidas dedicadas, tabelas melhoradas com hover effects, históricos separados por tipo] - [Cascade]
