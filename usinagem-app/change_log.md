# Log de Alterações
[02/04/2026 08:33] - [Frontend/Database] - [Rack acabado e numeração automática: coluna rack_acabado em apontamentos, tabela rack_counter e função obter_proximo_rack_usinagem(), geração automática USI-1001→USI-1999; correções de estados faltantes] - [Cascade]
[02/04/2026 08:20] - [Frontend] - [Relatórios: colunas Status, Nº OP, Cliente, Pedido.Cliente e totais de horas no OEE; ajustes na tabela diária] - [Cascade]
[02/04/2026 08:00] - [Frontend] - [Pasta usinagem-expedicao criada com cópia do frontend para app de expedição] - [Cascade]
