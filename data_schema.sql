...
-- Projeto: Usinagem App
-- Este script cria as tabelas, índices e políticas mínimas de RLS.
-- Para executar: abra o SQL Editor do Supabase e cole este conteúdo integralmente.
...
-- ============
-- Seeds opcionais (remova se não quiser)
-- ============
insert into public.tipos_parada (descricao) values
  ('Planejada'),('Não Planejada'),('Manutenção'),('Setup')
on conflict do nothing;

-- ============
-- Rollback (DROPs) — execute manualmente se precisar reverter
-- ============
-- drop policy if exists p_del_paradas on public.paradas; -- etc.
-- Para rollback total rápido:
-- drop table if exists public.paradas cascade;
-- drop table if exists public.apontamentos cascade;
-- drop table if exists public.pedidos cascade;
-- drop table if exists public.configuracoes cascade;
-- drop table if exists public.ferramentas_cfg cascade;
-- drop table if exists public.maquinas cascade;
-- drop table if exists public.motivos_parada cascade;
-- drop table if exists public.tipos_parada cascade;
